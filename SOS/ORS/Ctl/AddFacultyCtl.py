    ...
    def input_validation(self):
        ...
        if(DataValidator.isNull(self.form['firstName'])):
            ...
            if (DataValidator.isalphacheck(self.form['firstName'])):
                inputError['firstName']= "First Name conataions only letter"
                self.form['error'] = True
        ...
        if (DataValidator.isNull(self.form['email'])):
            ...
            if (DataValidator.isemail(self.form['email'])):
                inputError['email'] = "Email must be like abc@gmail.com"
                self.form['error'] = True
        ...
        if (DataValidator.isNull(self.form['dob'])):
            ...
            if (DataValidator.isDate(self.form['dob'])):
                inputError['dob'] = "Incorrect date formate, should be YYYY-MM-DD"
                self.form['error'] = True
    ...
    def submit(self, request, params={}):
        if (params['id'] > 0):
            ...
            if(duplicate.count() > 0):
                ...
                self.form['messege'] = "Email already exists"
                res = render(request,self.get_template(),{
                    'form': self.form, 'courseList': self.course_List, 'collegeList': self.college_List,
