...
class MarksheetMeritListService(BaseService):
    ...
    def search(self,params):
        sql = "select id,rollNumber,name,physics,chemistry,maths,(physics+chemistry+maths),(physics+chemistry+maths)/3 as percentage from marksheet_sos where physics>32 and chemistry>32 and maths>32 order by percentage desc limit 0,10;"
